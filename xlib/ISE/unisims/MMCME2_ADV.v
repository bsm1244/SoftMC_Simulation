// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/fuji/MMCME2_ADV.v,v 1.27.14.6 2013/05/30 21:14:23 vandanad Exp $
///////////////////////////////////////////////////////////////////////////////
...
//      end
 //     else
    ...
    if (CLKOUT0_DIVIDE_F > 1.0000 && CLKOUT0_DIVIDE_F < 2.0000)
      $display("Attribute Syntax Error : The Attribute CLKOUT0_DIVIDE_F on %s instance %m is set to %f.  Values in range of greater than 1 and less than 2 are not allowed.", MODULE_NAME, CLKOUT0_DIVIDE_F);
