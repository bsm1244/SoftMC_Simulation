// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/blanc/FIFO18E1.v,v 1.37.74.2 2013/01/16 01:33:56 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
"7SERIES" : begin
	...
	// async mode
	   ...
	   if (time_rdclk - time_wrclk == 0) begin
	  ...
	  if (rst_in === 1'b0) begin	    		
	   ...
	   end // if (time_rdclk - time_wrclk == 0)
	   else begin
	   ...
	   end // else: !if(time_rdclk - time_wrclk == 0)
